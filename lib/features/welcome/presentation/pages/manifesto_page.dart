                ...
                Row(
                  children: [
                    Flexible(
                      ...
                      child: SizedBox(
                        height: 54,
                        // largura mínima para o botão verde
                    ...
                    Flexible(
                      ...
                      child: SizedBox(
                        height: 54,
                        // largura mínima para o botão vermelho
                        width: double.infinity,
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFFEB4A4A), // cor corrigida
                            foregroundColor: Colors.white,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(6),
                            ),
                          ...
                          child: const Text(
                            'NÃO, NÃO ACEITO', // texto corrigido
                            style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 1.2),
                          ),
                        ),
                      ),
